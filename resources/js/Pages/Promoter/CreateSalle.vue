...
const submitForm = () => {
  ...
  const submitData = {
    ...
    statut: 'actif',
    horaires_ouverture: formData.value.horaires_ouverture,
...
<template>
  ...
  <div class="flex h-screen bg-gray-50">
    ...
    <main class="flex-1 overflow-y-auto lg:ml-64">
      <div
        class="sticky top-0 z-10 bg-white/80 dark:bg-[#19202e]/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 px-8 py-4">
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div class="flex min-w-72 flex-col gap-1">
            <p class="text-gray-900 dark:text-white text-xl font-bold leading-tight tracking-tight">Créer ma Salle</p>
            <p class="text-gray-600 dark:text-gray-400 text-sm font-normal leading-normal">Configurez les informations
              de votre salle</p>
          </div>
          <div class="flex items-center gap-3">
            <Link href="/promoter/venues"
              class="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-white dark:bg-[#19202e] border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-sm font-bold leading-normal tracking-[0.015em] hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
              <span class="truncate">Annuler</span>
            </Link>
            <button @click="submitForm"
              class="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-blue-500 transition-colors">
        ...
        <form class="max-w-4xl mx-auto space-y-8">
          ...
          <section class="bg-white dark:bg-[#19202e] border border-gray-200 dark:border-gray-800 rounded-xl p-6">
            ...
            <div class="mb-6">
              ...
              <GoogleMap :initial-lat="selectedLocation.lat" :initial-lng="selectedLocation.lng" height="400px"
                :readonly="false" @location-selected="handleLocationSelected" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input v-model="formData.region" type="text"
                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#19202e] text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary"
                  placeholder="Dakar">
              </div>
            </div>
            ...
            <div class="mt-6">
              ...
              <input v-model="formData.point_repere" type="text"
                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#19202e] text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary"
                placeholder="Près du marché Sandaga, à côté du centre commercial Sea Plaza">
          ...
          <section class="bg-white dark:bg-[#19202e] border border-gray-200 dark:border-gray-800 rounded-xl p-6">
            ...
            <div class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nom de la salle
                    *</label>
                  <input v-model="formData.nom" type="text"
                    class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#19202e] text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary"
                    placeholder="CyberZone Arena">
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Type de salle
                    *</label>
              ...
              <div>
                ...
                <textarea v-model="formData.description" rows="4"
                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#19202e] text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary"
                  placeholder="Décrivez votre salle, les équipements, l'ambiance..."></textarea>
              </div>
              ...
              <div>
                ...
                <select v-model="formData.categorie"
                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#19202e] text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary">
                  <option v-for="(nom, code) in mergedProps.categoriesSalle" :key="code" :value="code">{{ nom }}
                  </option>
                </select>
              </div>
            </div>
          ...
          <section class="bg-white dark:bg-[#19202e] border border-gray-200 dark:border-gray-800 rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input v-model="formData.whatsapp" type="tel"
                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#19202e] text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary"
              ...
              <div>
                ...
                <input v-model="formData.email" type="email"
                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#19202e] text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary"
                  placeholder="contact@cyberzone.sn">
              </div>
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Site web</label>
                <input v-model="formData.site_web" type="url"
                  class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#19202e] text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary"
                  placeholder="https://cyberzone.sn">
              </div>
            </div>
          </section>
          ...
          <section class="bg-white dark:bg-[#19202e] border border-gray-200 dark:border-gray-800 rounded-xl p-6">
            ...
            <!-- Contenu des horaires d'ouverture ici -->
            <p>Configuration des horaires à implémenter</p>
          </section>
        </form>
      </div>
    </main>
  ...
  <!-- Notification Modal -->
  <NotificationModal v-if="showNotificationModal" :type="notificationType" :title="notificationTitle"
