      ...
      <div class="w-full px-3 sm:px-4 md:px-6 py-4 sm:py-6 md:py-8">
        ...
        <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12 lg:col-span-5 bg-white dark:bg-slate-850 p-6 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col">
            ...
            <div class="mt-6 flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6">
              <div class="flex items-center gap-1.5 sm:gap-2 min-w-0 flex-shrink-0">
                <span class="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-green-500 flex-shrink-0"></span>
                <span class="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">Publiés ({{ stats?.publies || 0 }})</span>
              </div>
              <div class="flex items-center gap-1.5 sm:gap-2 min-w-0 flex-shrink-0">
                <span class="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-orange-500 flex-shrink-0"></span>
                <span class="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">Brouillons ({{ stats?.brouillons || 0 }})</span>
              </div>
              <div class="flex items-center gap-1.5 sm:gap-2 min-w-0 flex-shrink-0">
                <span class="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-red-500 flex-shrink-0"></span>
                <span class="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">Annulés ({{ stats?.annules || 0 }})</span>
              </div>
              <div class="flex items-center gap-1.5 sm:gap-2 min-w-0 flex-shrink-0">
                <span class="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-blue-500 flex-shrink-0"></span>
                <span class="text-xs sm:text-sm text-slate-600 dark:text-slate-400 truncate">Terminés ({{ stats?.passes || 0 }})</span>
              </div>
            </div>
          </div>
