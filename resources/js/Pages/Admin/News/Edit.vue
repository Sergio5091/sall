...
const form = useForm({
    ...
    image: null,
    is_active: props.news.is_active
});
...
<template>
    ...
    <div class="flex flex-col gap-6">
        ...
        <nav class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
            ...
            <span class="fas fa-chevron-right icon-sm text-slate-300"></span>
            <span class="text-slate-900 dark:text-white font-medium">Modifier</span>
        </nav>

        <!-- Page Heading -->
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <h2 class="text-3xl font-bold text-slate-900 dark:text-white tracking-tight">Modifier une Actualité</h2>
                <p class="text-slate-500 dark:text-slate-400 mt-1">Modifiez les informations de l'actualité "{{ news.title }}".</p>
            </div>
                    ...
                    <div>
                        ...
                        <div v-if="news.image" class="mt-2">
                            <img 
                                ...
                                :alt="news.title"
                                class="h-32 w-32 object-cover rounded-lg border border-slate-200 dark:border-slate-800"
                            >
                        </div>
