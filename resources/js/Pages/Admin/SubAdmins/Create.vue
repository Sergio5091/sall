...
const submit = () => {
    form.post(route('admin.sub-admins.store'));
};
</script>

<template>
  <Head title="Ajouter un sous-admin" />
  ...
  <div class="p-6">
    ...
    <div class="mb-6">
      <nav class="flex mb-4">
        ...
        <span class="text-gray-500">Ajouter</span>
      </nav>
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Ajouter un sous-admin</h1>
      <p class="text-gray-600 dark:text-gray-400 mt-1">Créer un nouveau sous-admin avec permissions géographiques</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      <form @submit.prevent="submit">
        ...
        <div class="mt-8 flex justify-end gap-4">
          ...
          >
            {{ form.processing ? 'Création...' : 'Créer le sous-admin' }}
          </button>
        </div>
      </form>
    </div>
