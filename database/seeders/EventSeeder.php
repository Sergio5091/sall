...
class EventSeeder extends Seeder
{
    ...
    private function createRealEvents()
    {
        ...
        $events = [
            ...
            // Événements pour VR Zone Saint-Louis (salle_id = 4)
            [
                'salle_id' => 4,
                'promoter_id' => 4,
                'titre' => 'VR Battle Royale',
                'description' => 'Tournoi de réalité virtuelle avec plusieurs jeux VR en mode battle royale. Prix de 200.000 FCFA',
                'slug' => 'vr-battle-royale',
                'date_debut' => Carbon::now()->addDays(12)->setTime(16, 0),
                'date_fin' => Carbon::now()->addDays(12)->setTime(22, 0),
                'date_limite_inscription' => Carbon::now()->addDays(10),
                'prix_base' => 3000,
                'devise' => 'XOF',
                'gratuit' => false,
                'capacite_max' => 40,
                ...
                'public_cible' => '16+',
                'age_minimum' => 16,
                'tags' => json_encode(['vr', 'battle royale', 'tournoi', 'réalité virtuelle', 'concours']),
                'contact_email' => 'vr@vrzone.sn',
                'contact_telephone' => '+221 77 876 54 32',
                'inscription_obligatoire' => true,
                'paiement_en_ligne' => true,
                'certificat_participation' => true,
                'streaming' => true,
                'url_streaming' => 'https://twitch.tv/vrzonesn',
                'statut' => 'publie',
                'visibilite' => 'public',
                'mis_en_avant' => true,
                'meta_titre' => 'VR Battle Royale Saint-Louis',
                'meta_description' => 'Tournoi VR battle royale avec prix de 200.000 FCFA à Saint-Louis.',
                'mots_cles' => json_encode(['vr', 'battle royale', 'saint-louis', 'tournoi', 'réalité virtuelle'])
            ],
            // Événements pour Laser Game Kaolack (salle_id = 5)
            [
                'salle_id' => 5,
                'promoter_id' => 5,
                'titre' => 'Laser Game Championship',
                'description' => 'Championnat régional de laser game par équipes. Inscription par équipe de 4 joueurs',
                'slug' => 'laser-game-championship',
                'date_debut' => Carbon::now()->addDays(18)->setTime(13, 0),
                'date_fin' => Carbon::now()->addDays(18)->setTime(19, 0),
                'date_limite_inscription' => Carbon::now()->addDays(16),
                'prix_base' => 10000, // Prix par équipe
                'devise' => 'XOF',
                'gratuit' => false,
                'capacite_max' => 80, // 20 équipes
                'places_disponibles' => 80,
                'limite_inscription' => true,
                'categorie' => 'championnat',
                'type' => 'offline',
                'public_cible' => '14+',
                'age_minimum' => 14,
                'tags' => json_encode(['laser game', 'championnat', 'équipe', 'compétition', 'kaolack']),
                'contact_email' => 'championship@lasergame.sn',
                'contact_telephone' => '+221 77 765 43 21',
                'inscription_obligatoire' => true,
                'paiement_en_ligne' => true,
                'certificat_participation' => true,
                'statut' => 'publie',
                'visibilite' => 'public',
                'meta_titre' => 'Laser Game Championship Kaolack',
                'meta_description' => 'Championnat régional laser game par équipes à Kaolack. Prix par équipe de 4 joueurs.',
                'mots_cles' => json_encode(['laser game', 'championnat', 'kaolack', 'équipe', 'compétition'])
            ],
            // Événements pour E-Space Mbour (salle_id = 6)
            [
                'salle_id' => 6,
                'promoter_id' => 6,
                'titre' => 'Formation Streaming Gaming',
                'description' => 'Formation complète pour devenir streamer gaming : setup, logiciel, monétisation et communauté',
                'slug' => 'formation-streaming-gaming',
                'date_debut' => Carbon::now()->addDays(25)->setTime(9, 0),
                'date_fin' => Carbon::now()->addDays(25)->setTime(17, 0),
                'date_limite_inscription' => Carbon::now()->addDays(23),
                'prix_base' => 15000,
                'devise' => 'XOF',
                'gratuit' => false,
                'capacite_max' => 25,
                ...
                'public_cible' => '16+',
                'age_minimum' => 16,
                'tags' => json_encode(['streaming', 'formation', 'twitch', 'youtube', 'gaming']),
                'contact_email' => 'formation@espace.sn',
                'contact_telephone' => '+221 77 654 32 10',
                'inscription_obligatoire' => true,
                'paiement_en_ligne' => true,
                'certificat_participation' => true,
                'statut' => 'publie',
                'visibilite' => 'public',
                'mis_en_avant' => true,
                'meta_titre' => 'Formation Streaming Gaming Mbour',
                'meta_description' => 'Formation complète streaming gaming à Mbour. Devenez streamer professionnel.',
                'mots_cles' => json_encode(['streaming', 'formation', 'mbour', 'twitch', 'gaming'])
            ],
            // Événements pour Battle Arena Touba (salle_id = 8)
            [
                'salle_id' => 8,
                'promoter_id' => 8,
                'titre' => 'League of Legends Tournament',
                'description' => 'Tournoi LoL 5v5 avec format élimination directe. Prix de 300.000 FCFA',
                'slug' => 'league-of-legends-tournament',
                'date_debut' => Carbon::now()->addDays(30)->setTime(10, 0),
                'date_fin' => Carbon::now()->addDays(30)->setTime(20, 0),
                'date_limite_inscription' => Carbon::now()->addDays(28),
                'prix_base' => 5000, // Prix par équipe
                'devise' => 'XOF',
                'gratuit' => false,
                'capacite_max' => 50, // 10 équipes
                'places_disponibles' => 50,
                'limite_inscription' => true,
                'categorie' => 'tournoi',
                'type' => 'offline',
                'public_cible' => '16+',
                'age_minimum' => 16,
                'tags' => json_encode(['league of legends', 'lol', 'moba', 'tournoi', 'équipe']),
                'contact_email' => 'lol@battlearena.sn',
                'contact_telephone' => '+221 77 432 10 98',
                'contact_whatsapp' => '+221 77 432 10 98',
                'inscription_obligatoire' => true,
                'paiement_en_ligne' => true,
                'certificat_participation' => true,
                'streaming' => true,
                'url_streaming' => 'https://twitch.tv/battlearenasn',
                'statut' => 'publie',
                'visibilite' => 'public',
                'mis_en_avant' => true,
                'meta_titre' => 'LoL Tournament Touba',
                'meta_description' => 'Tournoi League of Legends 5v5 à Battle Arena Touba. Prix de 300.000 FCFA.',
                'mots_cles' => json_encode(['league of legends', 'lol', 'touba', 'tournoi', 'moba'])
            ],
            // Événements pour Elite Gaming Kédougou (salle_id = 12)
            [
                'salle_id' => 12,
                'promoter_id' => 12,
                'titre' => 'Valorant Championship',
                'description' => 'Championnat Valorant avec équipes locales et invités. Qualification pour compétition nationale',
                'slug' => 'valorant-championship',
                'date_debut' => Carbon::now()->addDays(35)->setTime(14, 0),
                'date_fin' => Carbon::now()->addDays(35)->setTime(21, 0),
                'date_limite_inscription' => Carbon::now()->addDays(33),
                'prix_base' => 3000,
                'devise' => 'XOF',
                'gratuit' => false,
                'capacite_max' => 40,
                ...
                'public_cible' => '16+',
                'age_minimum' => 16,
                'tags' => json_encode(['valorant', 'fps', 'championnat', 'tactical', 'équipe']),
                'contact_email' => 'valorant@elitegaming.sn',
                'contact_telephone' => '+221 77 098 76 54',
                'inscription_obligatoire' => true,
                'paiement_en_ligne' => true,
                'certificat_participation' => true,
                'streaming' => true,
                'url_streaming' => 'https://twitch.tv/elitegamingsn',
                'statut' => 'publie',
                'visibilite' => 'public',
                'meta_titre' => 'Valorant Championship Kédougou',
                'meta_description' => 'Championnat Valorant à Elite Gaming Kédougou. Qualification compétition nationale.',
                'mots_cles' => json_encode(['valorant', 'championnat', 'kédougou', 'fps', 'tactical'])
            ]
        ];
