...
{
    /**
     * Afficher la liste des conversations du client
     */
    public function index(Request $request)
    {
        ...
        $query = Conversation::with(['promoter', 'reservation.salle', 'messages' => function ($query) {
        ...
        $conversations->getCollection()->transform(function ($conversation) use ($user) {
            ...
            return [
                ...
                'promoter_name' => $conversation->promoter->name,
        ...
        return Inertia::render('Client/Conversations', [
    ...
    public function show(Conversation $conversation)
    {
        ...
        return Inertia::render('Client/Conversation', [
            'conversation' => [
                ...
                'reservation_id' => $conversation->reservation_id,
                'promoter' => [
                    'name' => $conversation->promoter->name,
                    'email' => $conversation->promoter->email,
                ],
                'venue' => [
    ...
    public function sendMessage(Request $request, Conversation $conversation)
    {
        ...
        \App\Models\Notification::createForUser(
            $conversation->promoter_id,
            'Nouveau message',
            "Vous avez reçu un nouveau message d'un client concernant '{$conversation->reservation->salle->nom}'",
            'info',
            'conversation',
            $conversation->id
        );
